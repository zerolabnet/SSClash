...
```bash
curl -L https://github.com/zerolabnet/ssclash/releases/download/v4.1.0/luci-app-ssclash_4.1.0-r1_all.ipk -o /tmp/luci-app-ssclash_4.1.0-r1_all.ipk
opkg install /tmp/luci-app-ssclash_4.1.0-r1_all.ipk
rm /tmp/*.ipk
```
