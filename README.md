...
```bash
curl -L https://github.com/zerolabnet/ssclash/releases/download/v1.9.0/luci-app-ssclash_1.9.0-1_all.ipk -o /tmp/luci-app-ssclash_1.9.0-1_all.ipk
opkg install /tmp/luci-app-ssclash_1.9.0-1_all.ipk
rm /tmp/*.ipk
```
